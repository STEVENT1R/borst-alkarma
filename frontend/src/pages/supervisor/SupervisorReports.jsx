  ...
  <div>
    ...
    <div className="space-y-4">
      <Link to="/supervisor/task-logs" className="flex items-center gap-4 bg-white p-5 rounded-2xl shadow-sm border hover:border-green-300 transition-colors">
        <div className="bg-green-100 p-3 rounded-xl"><FileText className="text-green-600" size={24} /></div>
      ...
      <Link to="/supervisor/inventory-log" className="flex items-center gap-4 bg-white p-5 rounded-2xl shadow-sm border hover:border-green-300 transition-colors">
        <div className="bg-green-100 p-3 rounded-xl"><Package className="text-green-600" size={24} /></div>
      ...
      <Link to="/supervisor/cashflow-log" className="flex items-center gap-4 bg-white p-5 rounded-2xl shadow-sm border hover:border-teal-300 transition-colors">
        <div className="bg-teal-100 p-3 rounded-xl"><Wallet className="text-teal-600" size={24} /></div>
        <span className="font-bold text-gray-800">الخزنة والتدفق النقدي</span>
      </Link>
      <Link to="/supervisor/purchases-log" className="flex items-center gap-4 bg-white p-5 rounded-2xl shadow-sm border hover:border-orange-300 transition-colors">
        <div className="bg-orange-100 p-3 rounded-xl"><ShoppingCart className="text-orange-600" size={24} /></div>
      ...
      <Link to="/supervisor/shops-log" className="flex items-center gap-4 bg-white p-5 rounded-2xl shadow-sm border hover:border-indigo-300 transition-colors">
        <div className="bg-indigo-100 p-3 rounded-xl"><Store className="text-indigo-600" size={24} /></div>
